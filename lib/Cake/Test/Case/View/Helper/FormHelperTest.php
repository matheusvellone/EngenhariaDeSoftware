...
class FormHelperTest extends CakeTestCase {
    ...
    public function testRadio() {
        ...
        $result = $this->Form->radio(
                'Employee.gender', array('male' => 'Male', 'female' => 'Female'), array('form' => 'my-form')
        );
        $expected = array(
            'fieldset' => array(),
            'legend' => array(),
        ...
        $result = $this->Form->radio(
                'Model.field', array('a>b' => 'first', 'a<b' => 'second', 'a"b' => 'third')
        );
        $expected = array(
            'fieldset' => array(),
            'legend' => array(),
    ...
    public function testRadioDifferentModel() {
        ...
        $result = $this->Form->radio(
                'Model.field', array('v1' => 'option A', 'v2' => 'option B'), array('label' => true, 'legend' => false, 'value' => false)
        );
        $expected = array(
            array('input' => array(
    ...
    public function testSelectMultiple() {
        ...
        $result = $this->Form->select(
                'Model.multi_field', array('a>b' => 'first', 'a<b' => 'second', 'a"b' => 'third'), array('multiple' => true)
        );
        $expected = array(
            'input' => array(
    ...
    public function testDateTimeAllZeros() {
        $result = $this->Form->dateTime('Contact.date', 'DMY', false, array(
    ...
    public function testPostLinkFormBuffer() {
        ...
        $result = $this->Form->postLink('Delete', '/posts/delete/2', array('inline' => false, 'method' => 'DELETE')
        );
        $this->assertTags($result, array(
            'a' => array('href' => '#', 'onclick' => 'preg:/document\.post_\w+\.submit\(\); event\.returnValue = false; return false;/'),
            'Delete',
