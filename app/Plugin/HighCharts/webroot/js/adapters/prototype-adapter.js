...
var HighchartsAdapter = function() {
    ...
    return{init: function(a) {
            if (f)
                Effect.HighchartsTransition = Class.create(Effect.Base, {initialize: function(c, b, d, g) {
                        var e;
                        this.element = c;
                        this.key = b;
                        e = c.attr ? c.attr(b) : $(c).getStyle(b);
                        if (b === "d")
                            this.paths = a.init(c, c.d, d), this.toD = d, e = 0, d = 1;
            ...
            if (a._highcharts_extended && a._highchart_animation)
                for (c in a._highchart_animation)
                    a._highchart_animation[c].cancel()
        }, each: function(a, c) {
            $A(a).each(c)
            ...
            a._highcharts_extended || Object.extend(a, {_highchart_events: {}, _highchart_animation: null, _highcharts_extended: !0, _highcharts_observe: function(c,
                        a) {
