...
(function() {
        ...
        for (var c = "{", d = !1, e, f, g, h, i, j = []; (c = a.indexOf(c)) !== -1; ) {
            ...
            if (d) {
                ...
                for (h = 0; h < i; h++)
                    e = e[g[h]];
                if (f.length)
                    f = f.join(":"), g = /\.([0-9])/, h = P.lang, i = void 0, /f$/.test(f) ? (i = (i = f.match(g)) ? i[1] : 6, e = Na(e, i, h.decimalPoint, f.indexOf(",") > -1 ? h.thousandsSep : "")) : e = Ua(f, e)
            }
            j.push(e);
            a = a.slice(c + 1);
            c = (d = !d) ? "}" : "{"
    ...
    function Ab(a, b, c, d) {
        ...
        if (s(b)) {
            ...
            if (j >= A[Va])
                i[Bb](j >= A[Oa] ? 0 : k * T(i[kb]() / k));
            if (j >= A[Oa])
                i[Cb](j >= A[oa] ? 0 : k * T(i[lb]() / k));
            if (j >= A[oa])
                i[mb](j >= A[Pa] ? 1 : k * T(i[Qa]() / k));
    ...
    var la = function(a) {
        ...
        return{get: function(c) {
                ...
                if (d)
                    ...
                    var c;
                    for (c = 0; c < 3; c++)
                        b[c] += v(a * 255), b[c] < 0 && (b[c] = 0), b[c] > 255 && (b[c] = 255)
                }
                return this
    ...
    ra.prototype = {init: function(a, b) {
            ...
            if (fa(a))
                c = a, h === "circle" ? c = {x: "cx", y: "cy"}[c] || c : c === "strokeWidth" && (c = "stroke-width"), r = C(g, c) || this[c] || 0, c !== "d" && c !== "visibility" && (r = parseFloat(r));
            else {
                for (c in a)
                    if (j = !1, d = a[c], e = k[c] && k[c].call(this, d, c), e !== !1) {
                        ...
                        if (c === "d")
                            ...
                            for (e = 0; e < g.childNodes.length; e++)
                                f = g.childNodes[e], C(f, "x") === C(g, "x") && C(f, "x", d);
                        ...
                        if (c === "stroke-width" || c === "stroke") {
                            ...
                            if (this.stroke && this["stroke-width"])
                                C(g, "stroke", this.stroke), C(g, "stroke-width", this["stroke-width"]), this.hasStroke = !0;
                        ...
                        if (m && /^(width|height|visibility|x|y|d|transform)$/.test(c))
                            for (e = m.length; e--; )
                                C(m[e], c, c === "height" ? q(d - (m[e].cutHeight || 0), 0) : d);
        ...
        css: function(a) {
            ...
            if (this.added) {
                ...
                if (b.tagName === "SPAN") {
                    ...
                    if (I !== this.cTT) {
                        if (s(j))
                            a.isSVG ? (B = Da ? "-ms-transform" : db ? "-webkit-transform" : eb ? "MozTransform" : Jb ? "-o-transform" : "", k[B] = k.transform = "rotate(" + j + "deg)") : (p = j * bb, r = Y(p), p = ca(p), k.filter = j ? ["progid:DXImageTransform.Microsoft.Matrix(M11=", r, ", M12=", -p, ", M21=", p, ", M22=", r, ", sizingMethod='auto expand')"].join("") : O), M(b, k);
                        k =
    ...
    Ba.prototype = {Element: ra, init: function(a, b, c, d) {
            ...
            for (var b = a.element, c = this, d = c.forExport, e = o(a.textStr, "").toString().replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g,
                    "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g), f = b.childNodes, g = /style="([^"]+)"/, h = /href="([^"]+)"/, i = C(b, "x"), j = a.styles, k = j && j.width && v(j.width), m = j && j.lineHeight, l = f.length; l--; )
                b.removeChild(f[l]);
                    ...
                    if (e !== "" || l.length === 1) {
                        ...
                        if (k)
                            for (var e = e.replace(/([^\^])-/g,
                                    "$1- ").split(" "), s, t = []; e.length || t.length; )
                                delete a.bBox, s = a.getBBox().width, p = s > k, !p || e.length === 1 ? (e = t, t = [], e.length && (n = z.createElementNS(sa, "tspan"), C(n, {dy: m || 16, x: i}), q && C(n, "style", q), b.appendChild(n), s > k && (k = s))) : (n.removeChild(n.firstChild), t.unshift(e.pop())), e.length && n.appendChild(z.createTextNode(e.join(" ").replace(/- /g, "-")))
                    }
                })
            })
            ...
            if (g) {
                ...
                return f.test(a) ? (e = la(a), C(b, c + "-opacity", e.get("a")), e.get("rgb")) : (b.removeAttribute(c + "-opacity"), a)
        }, text: function(a,
                b, c, d) {
            ...
            function j() {
                ...
                if (z) {
                    if (!B)
                        a = t(-I * q), b = h ? -C : 0, r.box = B = d ? p.symbol(d, a, b, r.width, r.height) : p.rect(a, b, r.width, r.height, 0, v[Nb]), B.add(r);
            ...
            function k() {
                ...
                c = h ? 0 : C;
                if (s(La) && (a === "center" || a === "right"))
                    b += {center: 0.5, right: 1}[a] * (La - y.width);
                    ...
                    for (c in a)
                        if (d = a[c], l = !1, e = p[c] && p[c].call(this, d, c), e !== !1 && d !== null) {
                            ...
                            if (j && /^(x|y|r|start|end|width|height|innerR|anchorX|anchorY)/.test(c))
                                ...
                                for (l = []; e--; )
                                    if (ua(d[e]))
                                        l[e] = t(d[e] * 10) - 5;
                                            ...
                                            "Z")
                                        l[e] = "x";
                                    else if (l[e] = d[e], d[e] === "wa" || d[e] === "at")
                                        l[e + 5] === l[e + 7] && (l[e + 7] -= 1), l[e + 6] === l[e + 8] && (l[e + 8] -= 1);
                                d = l.join(" ") || "x";
                                f.path = d;
                                if (m)
                                    for (e = m.length; e--; )
                                ...
                                this[c] = d, c === "x" || c === "y" ? c = {x: "left",
                                    y: "top"}[c] : d = q(0, d), this.updateClipping ? (this[c] = d, this.updateClipping()) : g[c] = d, l = !0;
                            else if (c === "class" && h === "DIV")
                                f.className = d;
                            else if (c === "stroke")
                                d = i.color(d, f, c), c = "strokecolor";
                            else if (c === "stroke-width" || c === "strokeWidth")
                                f.stroked = d ? !0 : !1, c = "strokeweight", this[c] = d, ua(d) && (d += "px");
                            else if (c === "dashstyle")
        ...
        var ma = {Element: K, isIE8: za.indexOf("MSIE 8.0") > -1, init: function(a, b, c) {
            ...
            isHidden: function() {
                ...
                if (i) {
                    ...
                    if (c === "fill")
                        if (i === "gradient")
                            c = l.x1 || l[0] || 0, a = l.y1 || l[1] || 0, p = l.x2 || l[2] || 0, l = l.y2 || l[3] || 0, q = 'angle="' + (90 - N.atan((l - a) / (p - c)) * 180 / Ja) + '"', w();
                        else {
                    ...
                    f = la(a), h = ["<", c, ' opacity="', f.get("a"), '"/>'], U(this.prepVML(h), null, null, b), j = f.get("rgb");
                else {
    ...
    var Qb;
    if ($)
        Highcharts.CanVGRenderer = K = function() {
    ...
    Ia.prototype = {addLabel: function() {
            ...
            if (l && y)
                s === "inside" && (y = -y), d.opposite && (y = -y), b = this.getMarkPath(H, Q, y, l * D, g, f), p ? p.animate({d: b, opacity: c}) : this.mark = f.path(b).attr({stroke: q, "stroke-width": l, opacity: c}).add(d.axisGroup);
            if (i && !isNaN(H))
    ...
    ob.prototype = {render: function() {
            ...
            if (h) {
                if (r = b.getPlotLinePath(m, h), d = {stroke: B, "stroke-width": h}, l)
                    d.dashstyle = l
            } else if (k) {
                if (j = q(j, b.min - d), i = F(i, b.max + d), r = b.getPlotBandPath(j, i, e), d = {fill: B}, e.borderWidth)
            ...
            if (s(y))
                d.zIndex = y;
            if (p)
                r ? p.animate({d: r}, null, p.onGetPath) : (p.hide(), p.onGetPath = function() {
                    p.show()
                });
    ...
    ab.prototype = {defaultOptions: {dateTimeLabelFormats: {millisecond: "%H:%M:%S.%L", second: "%H:%M:%S", minute: "%H:%M", hour: "%H:%M", day: "%e. %b", week: "%e. %b", month: "%b '%y", year: "%Y"}, endOnTick: !1,
            ...
            for (f in d)
                J(this, f, d[f]);
            if (this.isLog)
                this.val2lin = na, this.lin2val = da
                ...
                if (g.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    if (a.isXAxis) {
                        if (j = g.xData, j.length)
                            a.dataMin = F(o(a.dataMin, j[0]), Fa(j)), a.dataMax = q(o(a.dataMax, j[0]), pa(j))
                    } else {
                        var Q, H, D, C = g.cropped, z = g.xAxis.getExtremes(), A = !!g.modifyValue;
                        k = j.stacking;
                        a.usePercentage = k === "percent";
                        if (k)
                            r = j.stack, p = g.type + o(r, ""), n = "-" + p, g.stackKey = p, m = d[p] || [], d[p] = m, l = e[n] || [], e[n] = l;
                        if (a.usePercentage)
                        ...
                        for (h = 0; h < u; h++) {
                            ...
                            I = B[h];
                            if (k)
                                H = (Q = I < t) ? l : m, D = Q ? n : p, s(H[y]) ? (H[y] = ia(H[y] + I), I = [I, H[y]]) : H[y] = I, c[D] || (c[D] = {}), c[D][y] || (c[D][y] = new Ib(a, a.options.stackLabels, Q, y, r, k)), c[D][y].setTotal(H[y]), c[D][y].touched = f;
            ...
            if (a >= 0.5)
                ...
                for (var f = T(b), h, i, j, k, m, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !m; f++) {
                    i = e.length;
                    for (h = 0; h < i && !m; h++)
                        j = na(da(f) * e[h]), j > b && k <= c && g.push(k), k > c && (m = !0), k = j
                }
                    ...
                    f) || 1)), a = ib(a, null, N.pow(10, T(N.log(a) / N.LN10))), g = Ka(this.getLinearTickPositions(a, b, c), na), !d)
            ...
            if (this.isLog) {
                ...
                for (b =
                        this.min + (b[0] - this.min) % c; b <= this.max; b += c)
                    d.push(b);
            return d
            ...
            if (e)
                !a && F(b.min, o(b.dataMin, b.min)) <= 0 && qa(10, 1), b.min = ia(na(b.min)), b.max = ia(na(b.max));
            ...
            if (!m && b.tickInterval < l)
                b.tickInterval = l;
            if (!f && !e && (a = N.pow(10, T(N.log(b.tickInterval) / N.LN10)), !m))
        ...
        getThreshold: function(a) {
            ...
            if (!a.axisGroup)
                a.gridGroup = c.g("grid").attr({zIndex: d.gridZIndex || 1}).add(), a.axisGroup = c.g("axis").attr({zIndex: d.zIndex || 2}).add(), a.labelGroup = c.g("axis-labels").attr({zIndex: r.zIndex || 7}).add();
            if (b || a.isLinked)
                n(e, function(b) {
                    f[b] ? f[b].addLabel() :
                            f[b] = new Ia(a, b)
                }), n(e, function(a) {
                    if (h === 0 || h === 2 || {1: "left", 3: "right"}[h] === r.align)
            ...
            if (a.hasData || f)
                if (n([j, k, m], function(a) {
                    ...
                    if (!f || b >= a.min && b <= a.max)
                        j[b] || (j[b] = new Ia(a, b)), q && j[b].isNew && j[b].render(c, !0), j[b].render(c, !1, 1)
                }), r && a.min === 0 && (j[-1] || (j[-1] = new Ia(a, -1, null, !0)), j[-1].render(-1))), p && n(g, function(b, c) {
                    if (c % 2 === 0 && b < a.max)
                        m[b] || (m[b] = new ob(a)), u = b + r, v = g[c + 1] !== w ? g[c + 1] + r : a.max, m[b].options = {from: e ? da(u) : u, to: e ? da(v) : v, color: p}, m[b].render(), m[b].isActive = !0
                }), !a._addedPlotLB)
    ...
    qb.prototype = {init: function(a,
            ...
            if (d && this.options.tooltip.shared &&
                ...
                for (i = 0; i < h; i++)
                    if (c[i].visible && c[i].options.enableMouseTracking !== !1 && !c[i].noSharedTooltip && c[i].tooltipPoints.length && (b = c[i].tooltipPoints[k], b.series))
                        b._dist = R(k - b.clientX), j = F(j, b._dist), e.push(b);
                for (h = e.length; h--; )
            ...
            if (a.type ===
                ...
                if (!i)
                    b.selectionMarker = i = u({destroy: ta}, c.plotBox);
            ...
            if (b)
                M(b.container, {cursor: "auto"}), b.cancelClick = this.hasDragged, b.mouseIsDown = this.hasDragged = this.hasPinched = !1, this.pinchDown = []
    ...
    rb.prototype = {init: function(a, b) {
            ...
            if (f && b.itemX - o + e > (l || c.chartWidth - 2 * k - o))
                b.itemX = o, b.itemY += r + b.lastLineHeight + p, b.lastLineHeight = 0;
            ...
            if (m || l) {
                ...
                if (i) {
                    ...
                    a.box = i = c.rect(0, 0, g, h, j.borderRadius, m || 0).attr({stroke: j.borderColor, "stroke-width": m || 0, fill: l || O}).add(d).shadow(j.shadow), i.isNew = !0;
                i[f ? "show" : "hide"]()
            }
            a.legendWidth = g;
            a.legendHeight = h;
            ...
            d > c && (d = c);
            if (d > 0)
                b !== w && Ha(b, this.chart), this.nav.attr({translateX: i, translateY: e + 7 + this.titleHeight, visibility: "visible"}), this.up.attr({fill: d ===
    ...
    sb.prototype = {init: function(a, b) {
        ...
        isInsidePlot: function(a, b, c) {
            ...
            if (!c)
                this.loadingDiv = c = U(xa, {className: "highcharts-loading"}, u(d.style, {left: this.plotLeft + "px", top: this.plotTop + "px", width: this.plotWidth + "px", height: this.plotHeight + "px", zIndex: 10, display: O}), this.container), this.loadingSpan = U("span", null, d.labelStyle, c);
            this.loadingSpan.innerHTML =
                    a || b.lang.loading;
            if (!this.loadingShown)
                M(c, {opacity: 0, display: ""}), vb(c, {opacity: d.style.opacity}, {duration: d.showDuration || 0}), this.loadingShown = !0
            ...
            if (f.display &&
                ...
                if (B === "right") {
                    if (!s(i))
                        this.marginRight = q(this.marginRight, f.legendWidth - r + p + c)
                } else if (B === "left") {
                    if (!s(h))
                        this.plotLeft = q(this.plotLeft, f.legendWidth + r + p + a)
                } else if (y === "top") {
                    if (!s(g))
            ...
            if (k)
                f ? f.animate(s) : this.plotBackground = b.rect(o, n, t, q, 0).attr({fill: k}).add().shadow(a.plotShadow);
            if (m)
                h ? h.animate(s) : this.plotBGImage = b.image(m, o, n, t, q).add();
            ...
            if (a.isReadyToRender())
                a.getContainer(), G(a, "init"), a.resetMargins(), a.setChartSize(), a.propFromSeries(), a.getAxes(), n(b.series || [], function(b) {
                    a.initSeries(b)
                }),
    ...
    Ma.prototype = {init: function(a, b, c) {
            ...
            c.firePointEvent(a ? "select" : "unselect", {accumulate: b}, function() {
                ...
                b || n(e.getSelectedPoints(), function(a) {
                    if (a.selected &&
                            a !== c)
                        a.selected = a.options.selected = !1, d.options.data[ka(a, d.data)] = a.options, a.setState(""), a.firePointEvent("unselect")
                })
            })
    ...
    S.prototype = {isCartesian: !0, type: "line", pointClass: Ma, sorted: !0, requireSorting: !0, pointAttrToOptions: {stroke: "lineColor", "stroke-width": "lineWidth", fill: "fillColor", r: "radius"}, colorCounter: 0, init: function(a, b) {
            ...
            this.bindAxes();
            u(this, {name: b.name, state: "", pointAttr: {}, visible: b.visible !==
            ...
            if (!e && !a.colorByPoint)
                s(b._colorIndex) ? a = b._colorIndex : (b._colorIndex = d.color, a = d.color++), e = c[a];
            this.color = e;
            ...
            if (l > (d.turboThreshold || 1E3)) {
                ...
                for (i = 0; i < l; i++)
                    if (a[i] !== w && (d = {series: this}, this.pointClass.prototype.applyOptions.apply(d, [a[i]]), j[i] = d.x, k[i] = n ? this.toYData(d) : d.y, m[i] = d.z, h && d.name))
                        h[i] = d.name;
            ...
            for (l = 0; l < g; l++)
                i = h + l, j ? m[l] = (new f).init(this, [d[l]].concat(ha(e[l]))) : (b[i] ? k = b[i] : a[i] !== w && (b[i] = k = (new f).init(this, a[i], d[l])), m[l] = k);
            if (b && (g !== (c = b.length) || j))
                for (l = 0; l < c; l++)
                    if (l === h && !j && (l += g), b[l])
            ...
            if (a)
                a = c[h], e = c[h + "m"], a || (c[h] = a = d.clipRect(u(f, {width: 0})), c[h + "m"] = e = d.clipRect(-99, g ? -c.plotLeft : -c.plotTop, 99, g ? c.chartWidth : c.chartHeight)), b.group.clip(a), b.markerGroup.clip(e), b.sharedClipKey = h;
            else {
                if (a = c[h])
                ...
                for (f = b.length; f--; )
                    if (g =
                        ...
                        if (a = g.pointAttr[g.selected ? "select" : ""], h = a.r, i = o(i.symbol, this.symbol), j = i.indexOf("url") === 0, k)
                            k.attr({visibility: l ? Z ? "inherit" : "visible" : "hidden"}).animate(u({x: d - h, y: e - h}, k.symbolName ? {width: 2 * h, height: 2 * h} : {}));
                        else {
                            if (l && (h > 0 || j))
            ...
            for (g = i.length; g--; ) {
                ...
                if (f) {
                    ...
                    f = d.hover = d.hover || {};
                    if (!b.marker)
                        f.color = la(f.color || h.color).brighten(f.brightness || e.brightness).get();
            ...
            if (j)
                j.attr({d: d});
            else if (a.tracker = j = h.path(d).attr({"class": "highcharts-tracker", "stroke-linejoin": "round", visibility: a.visible ? "visible" : "hidden", stroke: Mb,
    ...
    L = ea(S, {type: "area", getSegments: function() {
            ...
            if (this.options.stacking && !this.cropped) {
                ...
                S.prototype.getSegments.call(this), a = this.segments;
            this.segments = a
        }, getSegmentPath: function(a) {
    ...
    K = ea(S, {type: "column", tooltipOutsidePlot: !0, requireSorting: !1, pointAttrToOptions: {stroke: "borderColor", "stroke-width": "borderWidth", fill: "color", r: "borderRadius"}, trackerGroups: ["group", "dataLabelsGroup"], init: function() {
            ...
            if (h && (d = x(h), g && (d = {x: f.plotWidth - d.y - d.height, y: f.plotHeight -
                        d.x - d.width, width: d.height, height: d.width}), !j))
            ...
            if (e.enabled || a._hasPointLabels) {
                ...
                for (H = 2; H--; ) {
                    ...
                    if (m > 0) {
                        ...
                        for (D = 0; D < K; D++) {
                            ...
                            var P, O;
                            for (O = 0; O < v; O++)
                                P = R(b[O] - w[1]), P < c && (c = P, E = O);
                            if (E < D && b[D] !== null)
                                E = D;
                            else
                                for (v < K - D + E && b[D] !== null && (E = v - K + D); b[E] === null; )
                                    E++;
                            N.push({i: E, y: b[E]});
                            b[E] = null
                        }
                ...
                if (pa(F) === 0 || this.verifyDataLabelOverflow(F))
                    this.placeDataLabels(), s && g && n(this.points, function(b) {
                        ...
                        if ((u = b.dataLabel) &&
                                u._pos)
                            z = u.connX, A = u.connY, j = k ? ["M", z + (w[6] === "left" ? 5 : -5), A, "C", z, A, 2 * w[2] - w[4], 2 * w[3] - w[5], w[2], w[3], "L", w[4], w[5]] : ["M", z + (w[6] === "left" ? 5 : -5), A, "L", w[2], w[3], "L", w[4], w[5]], i ? (i.animate({d: j}), i.attr("visibility", G)) : b.connector = i = a.chart.renderer.path(j).attr({"stroke-width": g, stroke: e.connectorColor || b.color || "#606060", visibility: G}).add(a.group);
                        else if (i)
