...
<div class="debug-info">
    ...
    <div class="peak-mem-use">
        <?php echo $this->Toolbar->message(__d('debug_kit', 'Peak Memory Use'), $this->Number->toReadableSize($peakMemory)); ?>
    </div>
    ...
    foreach ($timers as $timerName => $timeInfo):
        ...
        $rows[] = array(
            ...
            $this->SimpleGraph->bar(
                    $this->Number->precision($timeInfo['time'] * 1000, 2), $this->Number->precision($timeInfo['start'] * 1000, 2), array(
                'max' => $maxTime * 1000,
