...
class BenchmarkShell extends Shell {
    ...
    public function getOptionParser() {
        ...
        $parser->description(__d('debug_kit', 'Allows you to obtain some rough benchmarking statistics' .
                ...
                ->epilog(__d('debug_kit', 'Example Use: `cake benchmark --n 10 --t 100 http://localhost/testsite`. ' .
