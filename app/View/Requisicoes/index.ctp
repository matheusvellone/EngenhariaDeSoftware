...
<div class="row">
    <div class="col-md-12 btn-group btn-group-justified">
        ...
        echo $this->Html->link('Todos', array('action' => 'index'), array('class' => 'btn ' . $classeParametro[4]));
        echo $this->Html->link('Espera', array('action' => 'index', 0), array('class' => 'btn ' . $classeParametro[0]));
        echo $this->Html->link('Em Andamento', array('action' => 'index', 1), array('class' => 'btn ' . $classeParametro[1]));
        echo $this->Html->link('Resolvido', array('action' => 'index', 2), array('class' => 'btn ' . $classeParametro[2]));
        echo $this->Html->link('Cancelado', array('action' => 'index', 3), array('class' => 'btn ' . $classeParametro[3]));
        ?>
    </div>
</div>
<hr>
