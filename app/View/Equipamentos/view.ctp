                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <ul class="nav nav-pills nav-stacked">
                            <li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-edit"></span>&nbsp&nbsp;Edit Equipamento'), array('action' => 'edit', $equipamento['Equipamento']['id']), array('escape' => false)); ?> </li>
                            <li><?php echo $this->Form->postLink(__('<span class="glyphicon glyphicon-remove"></span>&nbsp;&nbsp;Delete Equipamento'), array('action' => 'delete', $equipamento['Equipamento']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $equipamento['Equipamento']['id'])); ?> </li>
                            <li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-list"></span>&nbsp&nbsp;List Equipamentos'), array('action' => 'index'), array('escape' => false)); ?> </li>
                            <li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp&nbsp;New Equipamento'), array('action' => 'add'), array('escape' => false)); ?> </li>
...
<div class="related row">
    <div class="col-md-12">
        ...
        <?php if (!empty($equipamento['Requisicao'])): ?>
            <table cellpadding = "0" cellspacing = "0" class="table table-striped">
                <thead>
                    <tr>
                        <th><?php echo __('Id'); ?></th>
                ...
                <thead>
                <tbody>
                    <?php foreach ($equipamento['Requisicao'] as $requisicao): ?>
                        <tr>
